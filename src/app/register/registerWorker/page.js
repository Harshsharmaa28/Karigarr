...
export default function LoginWorker(){
    ...
    return(
        <>
            ...
            <div >
                <div className={'w-[100vw] h-[100vh] flex justify-center items-center bg-[url("/images/registerUser.jpg")] bg-cover md:bg-none '}>
                    <div className={'w-[80%] sm:w-[60%] h-[95%] md:h-[95%] md:w-[75%] lg:h-[90%] lg:w-[60%] flex-col md:flex md:flex-row items-center shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] border border-solid  rounded-2xl '}>
                        ...
                        <div className={' w-[100%] md:w-[50%] h-[100%] bg-white border md:border-0 border-solid rounded-2xl '}>
                            ...
                            <form className={'w-[100%] relative lg:top-[5rem] md:top-[3rem] md:mx-2'} >

                                <div className={'h-[10%] md:h-[15%] w-[75%] mx-auto my-2 md:m-4 flex border-b-2 border-solid  border-black  '}>
                                ...
                                {/*verify your aadhar*/}
                                <div className={'h-[10%] md:h-[15%] w-[100%] mx-auto my-2 md:m-4 flex md:flex-row flex-col md:justify-between '} >
                                    <div className={'h-[100%]  w-[75%] mx-auto flex border-b-2 border-solid border-black  '}>
                                        <label htmlFor={'aadhar'} className={' my-auto mx-2 pb-2'}><BiSolidPhone /></label>
                                        <input type={'number'} className={' w-[100%] mx-2 p-2 pb-3 focus:outline-none '} required placeholder={'Aadhar No.'} id={'aadhar'} name={'aadhar'} maxLength={10}></input>
                                    </div>
                                ...
                                <div className={'h-[10%] md:h-[15%] w-[75%] mx-auto my-2 md:m-4 flex border-b-2 border-solid border-black  '}>
                                    <label htmlFor={'phone'}  className={' my-auto mx-2 pb-2'} ><RiLockPasswordFill /></label>
                                    <input type={'phone'}  className={'mx-2  w-[100%] p-2 pb-3 focus:outline-none  '} autoComplete={'off'} placeholder={'Phone No.'} id={'phone'} name={'phone'} required ></input>
                                </div>
                                ...
                                <div className={'h-auto mx-auto my-2 md:m-4 w-[90%] text-sl text-center text-semibold text-white '}>
